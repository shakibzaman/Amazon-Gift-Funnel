...
<div id="loader" style="display:none;">
    <img src="/image/loader.gif" alt="Loading..." style="width: 100px; height: 100px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-success text-light" data-toggle="modal" id="mediumButton"
                                ...
                                data-attr="{{ route('admin.customer.review',$customer->review->id) }}"
                            ...
                            @if($customer->funnel_step == 'step4')
                            <button class="retry-transaction btn btn-danger text-light" data-id="{{ $customer->id }}">
                                Transaction Retry
                            </button>
                            @endif
                        </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="responseModalLabel">Transaction Retry</h5>
...
<style>
    #loader {
        position: fixed;
        width: 50%;
        /* Loader will take 50% of the screen width */
        left: 50%;
        top: 50%;
        ...
        text-align: center;
        /* Center the content inside the loader */
    }
</style>
@stop
@section('js')
...
<script>
    $(document).ready(function() {
    $('.retry-transaction').on('click', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: "/customer/order/retry/" + customerId,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
